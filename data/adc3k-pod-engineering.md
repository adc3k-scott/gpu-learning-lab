...
```
    ...
    |  CoolIT CHx2000               CoolIT CHx2000            |
    |  2,000 kW capacity            (N+1 redundant)           |
    |  Single rack footprint        2,000 kW capacity         |
    |  Serves 12 NVL72 racks                                  |
    |  2,100 LPM primary flow                                 |
    ...
    |                                                        |
    |  [QUICK-DISCONNECT: Staubli UQD]                       |
    |  NVIDIA-approved, OCP-compliant, drip-free, DN4-DN50   |
    |  Through container end wall to external heat rejection  |
    |  - 2x supply (redundant)                               |
    |  - 2x return (redundant)                               |
...
PREFERRED: 800V DC direct feed (Eaton Beam Rubin DSX)
  ...
  ORV3 Sidecar: +/-400V DC power rack with PSU, BBU, and capacitor tray.
  Up to 800 kW per rack row. Replaces traditional PDUs.

  DC circuit protection: ABB SACE Infinitus solid-state breaker
  (microsecond response, zero arc flash).

  Power conversion silicon:
  - TI 800V-to-6V GaN (97.6% efficiency)
  - Infineon CoolGaN IBC 800V-to-50V (>98% efficiency)
...
```
OPTION A: BAC TrilliumSeries Adiabatic Cooler (external to container)
  - Size: ~200 kW per unit, need 7 units (with N+1)
  - Footprint: ~8 ft x 4 ft each, stacked or side-by-side
  - Location: Adjacent to container, connected via Staubli UQD quick-disconnect
  - 44% peak energy reduction vs pure air-cooled
  - 90% less water than cooling towers
  - Runs dry in mild weather, adds water only on hot days
  - Epoxy-coated fins for Gulf Coast humidity/salt resistance
  - Pro: Near-zero water in mild weather, handles 95F+ Louisiana summer
  - Con: Larger footprint than cooling tower
  - Adiabatic assist handles 95F+ ambient — no derating issue unlike pure dry coolers
...
SOLUTION:
  ...
  - Fan spec: 2x Greenheck SBE-300 roof-mount exhaust fans (2,500 CFM each)

Humidity control: Munters HCD desiccant dehumidifier.
  - Precision to +/-1F dew point
  - Prevents condensation on cold cooling lines
  - No compressor — can use waste heat for reactivation
```
...
|--------|--------------|
| Suppression | Ansul Sapphire Novec 1230 (FK-5-1-12), ceiling-mounted nozzles |
| Detection | VESDA-E VEU aspirating smoke detection (Honeywell) |
...
| CDU — CoolIT CHx2000 (2,000 kW) | 2 | $50,000 | $100,000 |
...
| Fire suppression — Ansul Sapphire Novec 1230 | 1 | $15,000 | $15,000 |
| VESDA-E VEU (Honeywell) + sensors + monitoring | 1 lot | $10,000 | $10,000 |
...
| B | 2026-03-25 | Mission Control | Vendor-specific equipment: CoolIT CHx2000 CDU, BAC TrilliumSeries adiabatic cooler, Staubli UQD, ORV3 Sidecar, ABB SACE Infinitus, TI/Infineon GaN, Munters HCD, Greenheck SBE-300, Ansul Sapphire, VESDA-E VEU. Vendor BOM added. |
...
## 16. VENDOR BILL OF MATERIALS

All American-manufactured. Vendor lock confirmed per ADC procurement policy.

| Category | Vendor / Product | Notes |
|----------|-----------------|-------|
| **Compute** | NVIDIA NVL72 (GB200 / Vera Rubin) via HPE or Supermicro | OCP Open Rack V3, 72 GPUs per rack |
| **Power Distribution** | Eaton Beam Rubin DSX + ORV3 Sidecar | 800V DC direct, +/-400V sidecar with PSU/BBU/cap tray |
| **DC Protection** | ABB SACE Infinitus | Solid-state breaker, microsecond response, zero arc flash |
| **Power Conversion** | TI 800V-to-6V GaN (97.6% eff) + Infineon CoolGaN IBC 800V-to-50V (>98% eff) | Silicon-level power delivery |
| **Generator** | Caterpillar G3516J (1.6 MW) | Louisiana Cat dealer, natural gas backbone |
| **Solar** | First Solar Series 7 TR1 (550W) | New Iberia factory, 30 miles from Trappeys |
| **CDU** | CoolIT CHx2000 (2,000 kW) | Single rack footprint, 2,100 LPM, six 9s, ultracapacitor backup |
| **Heat Rejection** | BAC TrilliumSeries Adiabatic Cooler | 44% energy reduction, 90% less water, epoxy-coated fins |
| **Quick-Disconnect** | Staubli UQD | NVIDIA-approved, OCP-compliant, drip-free, DN4-DN50 |
| **Humidity Control** | Munters HCD desiccant dehumidifier | +/-1F dew point, waste heat reactivation, no compressor |
| **Exhaust** | Greenheck SBE-300 roof-mount fans | 2,500 CFM each, thermostat-controlled |
| **Fire Suppression** | Ansul Sapphire Novec 1230 | FK-5-1-12 clean agent, ceiling-mounted nozzles |
| **Smoke Detection** | VESDA-E VEU aspirating (Honeywell) | Very early smoke detection, 4 sampling points |
| **Container** | GTI Fabrication (US-made ISO) or Cajun Industries (New Iberia, LA) | 40-ft High Cube, modified per Section 7 |
