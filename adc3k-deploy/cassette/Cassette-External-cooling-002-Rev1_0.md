...
**Configuration B — Absorption chiller on-site.** Skid secondary loop feeds an on-board LiBr single-effect or double-effect absorption chiller driven by Cat G3520K exhaust heat. Gas-to-cooling thermal ratio typically 1.2 (1 kW heat input → 1.2 kW cooling at single-effect). At 2.5 MW cassette, this requires ~2.08 MW of genset exhaust heat. See Cassette-ABS-CHLR-001 (pending) for chiller sizing.
...
| CO-14 | P-3 | Absorption chiller interface spec for Configuration B: exhaust-gas-driven single-effect LiBr, 2.08 MW thermal input | ADC ↔ Thermax / Yazaki / Carrier | Gates ABS-CHLR-001 |
