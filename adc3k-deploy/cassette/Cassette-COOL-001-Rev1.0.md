...
**Companion documents:** Cassette-INT-001 Rev 1.0, Cassette-ECP-001 Rev 1.0, Cassette-BOM-001 Rev 1.0
...
| ID         | Document     | Location        | Current Spec                  | Corrected Spec                      | Basis  |
|------------|--------------|-----------------|-------------------------------|-------------------------------------|--------|
| BOM-CO-01  | BOM-001      | §14 per-rack coupling | Stäubli UQD-16            | **Stäubli UQD-25 or DN25 equiv.**   | §6 — UQD-16 needs 7 parallel per rack; UQD-25 needs 3 |
| BOM-CO-02  | BOM-001 / INT-001 §14 | Manifold headers | DN100 stainless       | **DN125 stainless (both supply & return)** | §5 — DN100 is undersized at CPX uprate flow |
| BOM-CO-03  | ECP-001      | §7 CHW flow spec | 1,800 LPM / 5 °C ΔT          | **2,200 LPM / 11 °C ΔT (NVL72 design point)** | §8 — 1,800 LPM causes 20.3 °C return, 2.3 °C over limit |
| BOM-CO-04  | ECP-001 / BOM-001 | §4 CDU fluid penetration | 4" DN100 Victaulic Style 77 | **6" DN150 Victaulic Style 77** | §8 — 4.6 m/s velocity exceeds ASHRAE 3.0 m/s limit at corrected flow |
...
**Cassette-COOL-001 — Cooling Hydraulic Model**
