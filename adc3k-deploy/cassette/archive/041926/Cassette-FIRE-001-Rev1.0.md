...
| Section | Current | Corrected | Action |
|---------|---------|-----------|--------|
| BOM §7 — Cylinders | 2 × 180 L, 25 bar, ~190 kg each | 2 × 200 lb fill Ansul Novec 1230, ~35 kg each | **BOM Rev 2.0** |
| INT-001 §17 — Cylinder weight | "~190 kg each" | "~35 kg each" | **INT-001 Rev 2.0** |
| INT-001 §17 — Cylinder bank location | "ELEC end" | Unchanged — 2 small cylinders still fit at ELEC end | No change |
| MASS-001 §8 — Fire suppression | 455 kg | ~180 kg (2 × 35 kg cylinders + VESDA + piping + misc) | **MASS-001 Rev 2.0** — reduces total pod mass by ~275 kg |

**MASS-001 impact:** The cylinder right-sizing removes ~275 kg from the cassette. This meaningfully improves ISO gross-weight compliance and partially addresses the weight concern from MASS-001.
...
**Cassette — Fire Suppression Engineering · Cassette-FIRE-001 · Rev 1.0 · 2026-04-19**
