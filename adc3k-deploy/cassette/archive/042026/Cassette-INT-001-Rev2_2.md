...
| 2.1 | 2026-04-19 | Rev 2.0 cleanup pass: §2 primary input reconciled with ELEC-001, §7 DC cable spec distinguishes ECP landing (laminated bus bar) from branch (2× 70 mm²), §11 busway 2,500→4,000 A, §29 BOM summary tables updated, §30 C-10 closed (UQD-16 moot) |
| 2.2 | 2026-04-19 | §2 nameplate operating weight updated to 29,935 kg per MASS-001 Rev 2.0 (A-02 baseline, Delta shelves in rack weight); companion doc cross-references updated |
...
| Primary input                   | 800 V DC (415 V AC 3-ph alternate, selected at commissioning per ELEC-001 §1)
| Cold plate supply/return        | 45 °C / 55–60 °C                         |
| Facility CHW supply/return      | 7–12 °C / 12–18 °C                       |
| PUE (Cassette level)                 | ≤ 1.06                                   |
| Operating weight                | 29,935 kg (A-02 baseline per MASS-001 Rev 2.0; within ISO 40 ft HC 30,480 kg limit)   |
...
- **Conductor:** Branch: 2× 70 mm² DC cable per rack (from busway tap to rack Delta shelf, ELEC-001 §8). ECP landing: 100×10 mm laminated copper bus bar per polarity (ELEC-001 §7)
...
|-------------------------------|--------------------------------------------|
| 800 V DC primary power        | 100×10 mm laminated copper bus bar per polarity (ECP landing), Stäubli CombiTac 2500 blind-mate, 2,500 A rated (ELEC-001 §7) |
| 415 V AC 3-ph alternative     | 3× 95 mm² L + 50 mm² N + 25 mm² G, Cam-Lok E1016 (L1/L2/L3/N/G), 400 A each per ELEC-001 §9 |
...
| Primary busway               | 800 V DC, 4,000 A copper laminated (ELEC-001 §13 — enables CPX upgrade)  |
...
| Cylinder weight (each)       | ~35 kg (200 lb fill + ~10 kg tare per FIRE-001 §5)  |
...
| Novec 1230 cylinder (200 lb fill)       | 2   |
...
| C-10  | ~~Stäubli UQD-16 lead time at 30-unit quantity~~ — CLOSED, superseded by UQD-25 (COOL-001 §6) | P-3  |
...
**Cassette — Interior Design Specification · Cassette-Interior-001 · Rev 2.2 · 2026-04-19**
