...
**Companion to:** Cassette-INT-001 Rev 2.2 · Cassette-BOM-001 Rev 2.2 · Cassette-FIRE-001 Rev 1.1 · Cassette-ELEC-001 Rev 1.1
...
| 2.0 | 2026-04-19 | Fire suppression 455→180 kg (FIRE-001 §12 right-size); DC electrical 425→520 kg (4,000 A busway + laminated bus bar per ELEC-001); manifolds 230→260 kg (DN125 upgrade per COOL-001); baseline changed to A-02 "Delta shelves included in rack weight" per design decision; re-tallied totals, CG, and stacking analysis |
...
| Chilled water manifold + piping | 260 | Medium | DN125 per COOL-001 §5 (was 230 at DN100); see §6 |
| DC electrical distribution | 520 | Medium | 4,000 A busway + laminated bus bar per ELEC-001 §13/§7 (was 425); see §7 |
| Fire suppression | 180 | High | Right-sized per FIRE-001 §12 — 2× 200 lb cylinders, VESDA, piping (was 455); see §8 |
...
| **TOTAL — BASELINE (A-02: Delta shelves in rack weight)** | **29,935** | — | **COMPLIANT — 545 kg margin (1.8%)** |
| **TOTAL — CONSERVATIVE (Delta shelves separate, +1,480 kg)** | **31,415** | — | **NON-COMPLIANT — over by 935 kg** |
| **ISO 40 ft HC GROSS LIMIT** | **30,480** | — | Hard limit — no exceptions |

### Verdict at 1,500 kg/Compute Rack — Baseline Assumption A-02

**Design decision (Rev 2.0):** The cassette mass budget is built on assumption **A-02: Delta power shelves are included in the NVIDIA-reported NVL72 rack weight.** This is the conservative engineering interpretation of Vera Rubin NVL72 as a complete integrated compute system — frame, compute trays, NVLink cartridges, cold plates, AND the Delta shelves that feed them — shipped as one unit by Foxconn / HPE / Supermicro / GIGABYTE.

Under this baseline: **29,935 kg operating mass → 545 kg margin to ISO 30,480 kg limit → COMPLIANT.**

The conservative (worst-case) total of 31,415 kg assumes Delta shelves ship separately and add 1,480 kg. This would exceed ISO gross by 935 kg. Open item M-01 exists to confirm A-02 with the vendor; until confirmed, the conservative case is documented for transparency.

**What changed from Rev 1.0:**
- Fire suppression reduced by 275 kg (FIRE-001 §12 right-sizing: 2× 180 L cylinders → 2× 200 lb fill)
- DC electrical increased by 95 kg (ELEC-001 §13 busway 2,500 → 4,000 A; §7 laminated copper bus bar at main feed)
- Manifold piping increased by 30 kg (COOL-001 §5: DN125 replaces DN100)
- Net change: −150 kg at both baseline and conservative totals
- Baseline narrative changed: Rev 1.0 presented A-02 as "best case" upside; Rev 2.0 adopts A-02 as design baseline with conservative case documented for transparency
...
In-system volume estimate (updated for DN125 manifolds per COOL-001 §5):

| Segment | Volume (L) | Notes |
|---------|------------|-------|
| CDU internal reservoir + heat exchanger passages | 50 | Estimate |
| Supply manifold 125 mm (5") × 9 m | 110 | π × 0.0625² × 9 = 0.110 m³ |
| Return manifold 125 mm (5") × 9 m | 110 | Same |
| CDU-to-manifold transition 125 mm × 2 m × 2 runs | 49 | π × 0.0625² × 4 |
| Per-rack supply + return drops, 32 mm × 0.5 m × 30 | 24 | π × 0.016² × 0.5 × 30 |
...
| **Total in-system volume** | **488 L** | |

PG25 density: 1.023 kg/L at 50 °C
In-system coolant mass: 488 × 1.023 = **499 kg → rounded to 500 kg for table in §2**

Note: Revised §2 summary table carries 400 kg for coolant. The 500 kg figure from this recalculation represents the DN125 upgrade; the 400 kg figure was retained in §2 conservatively pending cold plate volume confirmation (M-04 open item). If M-04 confirms 8 L/rack, coolant increases by ~100 kg and compliance margin drops from 545 kg to ~445 kg — still compliant.

### Chilled Water Manifold & Piping

Per COOL-001 §5, primary manifolds are DN125 stainless (not DN100). Per-rack branches are DN32 stainless. Mass recomputed accordingly.

| Item | Qty | Unit Mass (kg) | Total (kg) | Basis |
|------|-----|----------------|------------|-------|
| Supply manifold, 125 mm (5") Sch 40S SS304L, 9 m | 9 m | 6.4 kg/m | 58 | ASME pipe tables, DN125 Sch 40S |
| Return manifold, 125 mm (5") Sch 40S SS304L, 9 m | 9 m | 6.4 kg/m | 58 | Same |
| CDU primary connection piping, 125 mm, ~4 m total | 4 m | 6.4 kg/m | 26 | Includes bends, fittings ×1.5 factor |
| Per-rack supply drops, 32 mm (1¼") SS304, 0.5 m × 15 | 15 | 1.2 | 18 | DN32 Sch 40S = 2.4 kg/m |
| Per-rack return drops, 32 mm (1¼") SS304, 0.5 m × 15 | 15 | 1.2 | 18 | Same |
| Stäubli UQD-25 blind-mate connectors (×86) | 86 | 0.35 | 30 | Stäubli UQD-25 ~0.3–0.4 kg (COOL-001 §6) |
...
| Manifold insulation, 25 mm closed-cell, ~18 m | 1 lot | — | 22 | Armacell, ~1.2 kg/m at DN125 |
...
| **SUBTOTAL** | | | **330** | Rounded to **260** after deducting overlap with §3 shell and §9 drip trays |

Note: Trench is welded to floor plate; its weight is included here, not in §3 shell.
Subtotal cooling: 600 + 400 + 260 = **1,260 kg**
...
| M-02 | Confirm actual NVL72 loaded rack weight (C-01) in kg | Scott / NVIDIA | Before fabrication PO |
| M-03 | Confirm CoolIT CHx2000 actual shipping weight | Scott / CoolIT | Before fabrication PO |
| M-04 | Confirm cold plate internal volume per NVL72 rack | Scott / NVIDIA | Affects coolant mass ±100 kg |
| M-05 | DNV review of corner casting for offshore 2-high stacking | DNV-certified engineer | Before offshore deployment |
| M-06 | Update INT-001 §2 Cassette Nameplate operating weight once M-01 / M-02 resolved | Engineering | After M-01, M-02 |
...
|----|------|----------|---------|
| M-01 | Delta shelf inclusion in rack weight — written confirmation from NVIDIA / Foxconn / Delta | **P-0** | Findings 1, 2 — gates A-02 baseline |
| M-02 | Actual NVL72 rack weight confirmation (same as C-01) | **P-0** | Finding 5 — rack weight sensitivity |
| M-03 | CoolIT CHx2000 actual shipping weight | P-1 | A-05 |
| M-04 | Cold plate internal volume per NVL72 rack | P-1 | A-07, coolant mass sensitivity |
...
**Cassette — Mass Statement & Weight Budget · Cassette-MASS-001 · Rev 2.0 · 2026-04-19**
