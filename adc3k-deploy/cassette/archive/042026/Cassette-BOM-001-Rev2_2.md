...
| 2.1 | 2026-04-19 | Rev 2.0 cleanup: §4 per-rack AC cable 35→95 mm², §9 CDU subpanel 60→80 A, §14 IEC 60309 both 80 A, §15 main DC input laminated bus bar + CDU feed 10→25 mm² (ELEC-001 §7, §17) |
| 2.2 | 2026-04-19 | Companion document cross-references updated (INT Rev 2.2, ECP Rev 2.2, COOL Rev 1.1, ELEC Rev 1.1, FIRE Rev 1.1, MASS Rev 2.0); no parts changes |
...
| Pin-and-Sleeve IEC 60309 (CDU + Munters power) | 2   | Mennekes or Meltric  | 80 A each (ELEC-001 §17; CDU corrected from 60 A)      |
...
**Cassette — Bill of Materials · Cassette-BOM-001 · Rev 2.2 · 2026-04-19**
