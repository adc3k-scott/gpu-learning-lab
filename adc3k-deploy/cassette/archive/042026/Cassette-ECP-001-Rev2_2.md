...
| 2.1 | 2026-04-19 | Rev 2.0 cleanup pass: §4 ASCII diagram 4"→DN150, §5 main cable spec corrected to laminated bus bar (ELEC-001 §7), §17 connector reference UQD-16→UQD-25 (COOL-001 §6) |
| 2.2 | 2026-04-19 | Companion document cross-references updated (INT Rev 2.2, BOM Rev 2.2, COOL Rev 1.1, ELEC Rev 1.1, FIRE Rev 1.1, MASS Rev 2.0); no interface changes |
...
|                                                  |
|  [1] CHW supply  6" (DN150) Victaulic            |  ← Lower (fluid)
|  [2] CHW return  6" (DN150) Victaulic            |
|                                                  |
...
| Cable (pod-internal landing)     | Laminated copper bus bar, 100×10 mm per polarity, ~600 mm service loop (ELEC-001 §7 — 2× 70 mm² cable is rated 265 A, inadequate for 1,981 A) |
...
| UQD (fluid disconnect)       | Stäubli UQD-25 (COOL-001 §6 — UQD-16 requires 7/rack, impractical) |
...
| 2.1 | 2026-04-19 | A (non-breaking) | Rev 2.0 cleanup: §4 ASCII, §5 main cable spec, §17 UQD-25 reference |
| 2.2 | 2026-04-19 | A (non-breaking) | Companion document cross-references updated; no interface changes |

---

**Cassette — External Connection Panel Interface Control Document**
**Cassette-ECP-001 · Rev 2.2 · 2026-04-19**
