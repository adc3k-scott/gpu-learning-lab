...
**Companion to:** Cassette-INT-001 Rev 3.0 · Cassette-ECP-001 Rev 3.0 · Cassette-COOL-002 Rev 1.0 · Cassette-CDUSKID-001 Rev 1.0 · Cassette-ELEC-001 Rev 1.2 · Cassette-FIRE-001 Rev 1.2 · Cassette-MASS-001 Rev 3.0
...
**Rev 3.0 scope note:** This BOM covers the **Cassette interior only**. External CDU skid, Munters skid, gensets, absorption chiller, and switchgear are covered by their respective procurement documents (CDUSKID-001 for CDU skid; GENSET-001, SWGR-001, ABS-CHLR-001 pending). Cassette-side flexible hose interface to the external CDU skid is identified in §5 as a long-lead item procured by ADC.
...
| 2.1 | 2026-04-19 | Rev 2.0 cleanup: §4 per-rack AC cable 35→95 mm², §9 CDU subpanel 60→80 A, §14 IEC 60309 both 80 A, §15 main DC input laminated bus bar + CDU feed 10→25 mm² |
| 2.2 | 2026-04-19 | Companion document cross-references updated; no parts changes |
| **3.0** | **2026-04-20** | **BREAKING CHANGE. §5 rewritten: CoolIT CHx2000 CDU line items deleted (moved to external skid — see CDUSKID-001). CDU-side piping, expansion tank, PG25 coolant charge rescoped to Cassette-internal-only (180 L vs. former ~500 L). §14 CDU ECP hardware: 2× Victaulic DN150 CHW couplings deleted, replaced with 2× Stäubli QBH-150 PG25 QD plus mounting plate; IEC 60309 CDU power feed deleted; added PG25 fill/top-off port hardware. Flexible hose pair (Cassette-to-skid) added at §5 as ADC-furnished interconnect. Mass impact: −850 kg CoolIT/plumbing, +35 kg QD plate, +180 kg PG25 initial charge = net −635 kg.** |
...
| Per-rack AC input cable assembly [ALT]         | 13 if AC | Assembled              | 3× 95 mm² L + 50 mm² N + 25 mm² G × 2 m (ELEC-001 §17; 4× 35 mm² was undersized)  |
...
## §5  COOLING — CASSETTE PRIMARY PG25 LOOP (REV 3.0)

**Rev 3.0 scope: Cassette interior only.** External CDU skid (HX, pumps, filtration, buffer tank, secondary CHW loop) is procured via Cassette-CDUSKID-001. CoolIT CHx2000 line items from Rev 2.2 are deleted.

### §5.1  Primary PG25 Piping & Manifolds (Cassette Interior)

| Item                                           | Qty | Vendor / Source      | Notes                              |
|------------------------------------------------|-----|----------------------|------------------------------------|
| Stainless supply manifold, 125 mm (5"), 304L   | ~9.3 m | Victaulic or Swagelok | Floor trench, insulated (9,332 mm per INT-001 Rev 3.0 §5) |
| Stainless return manifold, 125 mm (5"), 304L   | ~9.3 m | Victaulic or Swagelok | Floor trench, insulated           |
| Per-rack supply drop, 1½" (DN40) stainless     | 13  | Local fab            | DN40 × ~500 mm each (compute racks) |
| Per-rack return drop, 1½" (DN40) stainless     | 13  | Local fab            | DN40 × ~500 mm each                |
| Per-rack supply drop, 1" (DN25) stainless      | 2   | Local fab            | R14 + R15 (lower flow)             |
| Per-rack return drop, 1" (DN25) stainless      | 2   | Local fab            | R14 + R15                           |
| Stäubli UQD-25 blind-mate disconnect           | 86  | Stäubli              | 43 supply + 43 return (3 per compute rack; 1 per R14/R15) |
...
| Welding consumables (308L or 316L filler, argon) | AR | Local welding supply | Sealed-vessel weld spec per INT-001 §27 |

### §5.2  PG25 QD Plate & Termination (Service End Zone → CDU-end ECP)

| Item                                           | Qty | Vendor / Source      | Notes                              |
|------------------------------------------------|-----|----------------------|------------------------------------|
| QD mounting plate, 316L stainless, 300×600×20 mm | 1 | Local fab          | TIG-welded to interior bulkhead per ECP-001 Rev 3.0 §7 |
...
| Item                                           | Qty | Vendor / Source      | Notes                              |
|------------------------------------------------|-----|----------------------|------------------------------------|
| PG25 coolant initial charge (Cassette interior) | ~180 L | Dowfrost HD or DynaCool | Propylene glycol 25% v/v + organic acid inhibitor; factory-filled per INT-001 Rev 3.0 §27 |
...
### §5.5  Cassette-to-Skid Interconnect (ADC-Furnished Accessories)

Per ECP-001 Rev 3.0 §18. Supplied with Cassette, installed on-site.
...
> **Deleted in Rev 3.0** (now in external CDU skid, not Cassette BOM):
> - CoolIT CHx2000 CDU unit
> - CoolIT touchscreen kit
> - Expansion tank (moved to skid)
> - CDU-internal piping and supports
> - Excess PG25 charge (~320 L that sits in skid buffer tank)
...
| CDU power panel (480 V AC 3-ph, 80 A)          | 1   | Eaton or Siemens     | Subpanel at CDU end (ELEC-001 §17; 60 A was undersized for NEC 125% = 67 A) |
...
| Pin-and-Sleeve IEC 60309 (Munters power only)  | 1   | Mennekes or Meltric  | 80 A (Rev 3.0: CDU power feed deleted — no internal CDU) |
| NPT fittings (condensate, leak, N2, test, fill) | 5  | Swagelok             | 1", 1", 1/2", 1/4", 1/2" (fill port added Rev 3.0) |
...
|------------------------------------------------|------------|---------------------|
| 800 V DC primary — laminated copper bus bar, 100×10 mm per polarity (ELEC-001 §7) | ~1.5 m | Custom fab — Eaton/ABB/Schneider |
...
| 480 V AC CDU power feed, 3× 25 mm² + G (16 mm²) per ELEC-001 §17 | ~6         | Southwire           |
...
| **Stäubli QBH-150 DN150 PG25 QDs (2)** (Rev 3.0) | 12–16 weeks  | BLOCKING    |
| Stäubli CombiTac 2500 connectors               | 12 weeks       | HIGH        |
| **Flexible DN150 braided hoses, 5 m (2)** (Rev 3.0) | 10–12 weeks | HIGH       |
| Bender iso-PV1685 IMD                          | 10 weeks       | HIGH        |
| Ansul Novec 1230 cylinders                     | 10–12 weeks    | HIGH        |
| Munters HCD-600                                | 8–12 weeks     | HIGH        |
| Stäubli UQD-25 (86 units)                      | 8 weeks        | MEDIUM      |
| VESDA-E VEU                                    | 6–8 weeks      | MEDIUM      |
| ~~CoolIT CHx2000 CDU~~                         | ~~DELETED Rev 3.0~~ | — (see CDUSKID-001 for external skid) |
| ~~Victaulic Style 77 couplings (CHW)~~         | ~~DELETED Rev 3.0~~ | — (replaced by PG25 QDs above) |
...
**Cassette — Bill of Materials · Cassette-BOM-001 · Rev 3.0 · 2026-04-20**
