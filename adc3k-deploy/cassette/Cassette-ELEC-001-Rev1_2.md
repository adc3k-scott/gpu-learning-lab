...
**Companion to:** Cassette-INT-001 Rev 3.0 · Cassette-ECP-001 Rev 3.0 · Cassette-BOM-001 Rev 3.0 · Cassette-MASS-001 Rev 3.0 · Cassette-COOL-002 Rev 1.0 · Cassette-CDUSKID-001 Rev 1.0
...
| 1.1 | 2026-04-19 | Rev 1.0 analysis resolutions noted: §13 (busway upgrade to 4,000 A) and §17 (BOM discrepancies) adopted in BOM Rev 2.1. Analysis text preserved as audit trail; resolution status annotated inline. |
| **1.2** | **2026-04-20** | **Companion documents updated to Rev 3.0 baseline (INT, ECP, BOM, MASS) plus new external CDU architecture (COOL-002, CDUSKID-001). No change to cassette-internal electrical architecture. CDU power feed at ECP (previously penetration #10 in ECP-001) deleted — see ECP-001 Rev 3.0 §4. Skid-side 480 V AC electrical service is now customer-furnished to the external CDU skid, not routed through the cassette. Auxiliary circuit count at ECP-11 (Munters power feed) unchanged.** |
...
**RESOLUTION (Rev 1.1):** 4,000 A busway adopted in BOM Rev 2.1. Analysis below is preserved as the audit trail showing why 2,500 A was rejected and 4,000 A was selected.

| Busway | NVL72 Utilization | NVL144 CPX Utilization | Enables CPX Upgrade? | Relative Cost |
|--------|-------------------|------------------------|----------------------|---------------|
| 2,500 A (rejected) | 79.2% (marginal) | Non-compliant | No | Baseline |
| 3,000 A (rejected) | 66% | 87.7% (marginal) | No (marginal) | ~+20% |
| **4,000 A (adopted in BOM Rev 2.1)** | **49.5%** | **65.8%** | **Yes ✓** | **~+45%** |
...
**RESOLUTION (Rev 1.1):** All corrections in this section have been adopted in BOM Rev 2.1. Table below is preserved as the audit trail.

The following items in BOM Rev 1.0 required correction based on this electrical analysis:

| Item | BOM Rev 1.0 | Corrected Spec | Impact | Status |
|------|-------------|----------------|--------|--------|
| DC busway (§9) | 2,500 A | **4,000 A, 800 V DC** | Enables CPX upgrade path | ✓ Adopted BOM Rev 2.1 |
| 800 V DC main cable (§15) | 2× 70 mm² XHHW-2 | **100×10 mm laminated copper bus bar per polarity** | 70 mm² is rated 265 A — cannot carry 1,981 A | ✓ Adopted BOM Rev 2.1 |
| Per-rack AC cable (§4, alternate) | 4× 35 mm² | **3× 95 mm² + N (50 mm²) + G (25 mm²)** | 35 mm² is insufficient for 175 A per phase | ✓ Adopted BOM Rev 2.1 |
| CDU power connector (§14 ECP) | IEC 60309, 60 A | **IEC 60309, 80 A** | CDU at 40 kW / 480V 3-ph requires up to 67 A — 60 A connector is undersized | ✓ Adopted BOM Rev 2.1 |
| CDU power feed cable (§15) | 4× 10 mm² | **3× 25 mm² + G (16 mm²)** | 10 mm² = 40 A; need 67 A | ✓ Adopted BOM Rev 2.1 |

**All Rev 1.0 discrepancies resolved as of BOM Rev 2.1.**
...
**Cassette — Electrical Single-Line Diagram & Distribution Specification**
**Cassette-ELEC-001 · Rev 1.2 · 2026-04-20**
