...
W, H = 1400, 1050
OUT = "adc3k-deploy/blueprints/marlie-power-distribution.svg"
...
def build():
    ...
    box(dwg, 620, y1, 130, 55, "LUS + SLEMCO\nGRID\nBACKUP ONLY", "Layer 4 — dual feed",
    ...
    box(dwg, 30, y2, 140, 65, "CAT G3520C #1\n1.5 MW | 480V AC\nNatural Gas Prime\nLayer 2 Backbone",
        "Louisiana Cat | American Made",
        color="#0a1a0a", border="#22c55e", text_color="#22c55e")
    box(dwg, 185, y2, 140, 65, "CAT G3520C #2\n1.5 MW | 480V AC\nN+1 REDUNDANT\nMaintenance Spare",
    ...
    # ================================================================
    # ROW 7-8: BUSWAY -> RACKS (Floor 1 + Floor 2)
    # ================================================================
    y7 = y6 + 25
    y8 = y7 + 40
    y9 = y8 + 40
    ...
    for bx, label in f1_positions:
        ...
        box(dwg, bx, y7, 80, 30, f"BUSWAY\n{label}", "",
            border="#8b5cf6", text_color="#c4b5fd", font=8)
        arrow_down(dwg, bx + 40, y7 + 30, y8, "#8b5cf6")
        box(dwg, bx + 5, y8, 70, 28, "PDU + LLC\n800V->12.5V", "",
    ...
    dwg.add(dwg.rect((hx, hy), (590, 820), rx=8, fill="#111318", stroke="#1e2230", stroke_width=1))
    ...
    layers = [
        {
            ...
            "details": [
                ...
                "960 sq ft roof = ~55 First Solar TR1 panels",
                "DC-Direct to 800V bus (97% eff)",
                "Small scale but meaningful offset (~24%)",
                "600 kWh BESS battery bridge",
        ...
        },
        {
            ...
            "details": [
                ...
                "~41% load per unit (1.24 MW on 3 MW)",
            ]
        },
        {
    ...
    notes = [
        ...
        "3. MARLIE I is smaller (1,920 sq ft vs 112,500 sq ft) — grid backup makes sense at this scale.",
        "4. N+1 generator redundancy: 2x G3520C for 1.24 MW load. Either unit offline = zero impact.",
        "5. Solar DC-Direct: 300 kW rooftop feeds 800V bus at 97% efficiency. ~24% offset of total load.",
        "6. BESS 600 kWh provides ride-through during transfer events + battery bridge for short outages.",
    ]
