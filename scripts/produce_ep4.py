"""
AI Daily Omniverse — Episode 4 Production (2026-03-27)
...
EPISODE_DIR = Path(__file__).parent.parent / "data" / "episodes" / "2026-03-27"
...
def main():
    print("=" * 60)
    print("  AI Daily Omniverse -- Episode 4 Production")
    ...
    print()
    print("Next: python scripts/assemble_newscast.py 2026-03-27")
    print("=" * 60)
